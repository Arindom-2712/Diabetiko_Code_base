...
public  class testListAdapterAlterative extends BaseAdapter
{
	Activity context;
	String Name[];
	String Location[];
	String mTimings[];
	int mIdentify;
	public testListAdapterAlterative(Activity context, String[] Names, String[] Locations, 
			String[] Timings,int identify) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		try
		{
			...
			holder.txtViewDescription.setText( Location[ position ] );
